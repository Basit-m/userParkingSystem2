...
public class LoginTab extends JPanel {
    ...
    private void login(ActionEvent e) {
        ...
        if(loggedUser != null) {
            if(loggedUser.equals(SuperManager.getInstance())) {
    ...
    public void refreshTabs() {
        ...
        if (tabs.getTitleAt(index).equalsIgnoreCase("Pay")) {
            paymentTab.refreshOptions();
        }
    }
